...
n_estimators_1 = st.sidebar.slider('Количество фолдов:', min_value=3, max_value=100, value=3, step=1)

st.sidebar.header('Градиентный бустинг')
n_estimators_2 = st.sidebar.slider('Количество переобучений:', min_value=3, max_value=100, value=3, step=1)
...
n_estimators_3 = st.sidebar.slider('Количество K (соседей):', min_value=3, max_value=100, value=3, step=1)
...
st.subheader('Нахождение лучшего градиентного бустинга')
